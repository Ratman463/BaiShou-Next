...
本目录包含 BaiShou-Next 的版权、贡献者协议（CLA）及商业化许可策略。
...
| [CLA-corporate.md](./CLA-corporate.md)       | 企业贡献者许可协议（中英文）                                                   |
| [TRADEMARK.md](./TRADEMARK.md)               | 商标使用指引                                                                   |
| [signatures/](./signatures/)                 | CLA 签署记录（由 [CLA Assistant](https://cla-assistant.io/) 管理，见下方配置） |
| [CLA-GITHUB-SETUP.md](./CLA-GITHUB-SETUP.md) | **维护者**：启用 PR 内一键签署                                                 |
