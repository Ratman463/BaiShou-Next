...
async function executeSaveUserMessage(
...
export async function saveUserMessage(
  ...
  try {
    return await mobileAgentDbRecovery.runWithRecovery(
      () => executeSaveUserMessage(sessionRepo, sessionManager, pathService, fileSystem, args),
      `saveUserMessage(${args.sessionId})`,
      () => {
