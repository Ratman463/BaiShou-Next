...
export function useSummaryDashboardMock() {
  ...
  const handleCopyContext = () => {
    console.log('Context copied to clipboard mock');
  };

  const summaries = [
    { id: '1', title: '2026年第13周', dateRange: '03.24-03.30', type: 'week' as const, summaryText: '本周完成了跨 Agent 并行流的设计。' },
    { id: '2', title: '2026年3月总结', dateRange: '03.01-03.31', type: 'month' as const, summaryText: '整个三月都沉浸在 BaiShou Next 的双端代码迁移和架构设计中。' }
  ];
